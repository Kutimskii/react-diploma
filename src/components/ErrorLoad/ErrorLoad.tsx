...
export const ErrorLoad: React.FunctionComponent<IErrorLoad> = ({error, updateFetch}:IErrorLoad) => {
  return (      
    ...
    <button type='button' className='error_button' onClick={updateFetch}>Попробовать еще раз</button>
  </div>);
}